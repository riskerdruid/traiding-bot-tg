...
Здесь же считается вся статистика, которую видит пользователь: сколько
сигналов дошло до цели, сколько до стопа и что из этого вышло в деньгах.
Расчёты держим в одном месте — по ним человек судит о боте.
"""
