...
class StrategyResult:
    ...
    `reasons` — человекочитаемые причины, они уходят в сообщение трейдеру
    и в Mini App. Без них сигнал выглядит как чёрный ящик, которому
    не доверяют.
    """
...
class Strategy(ABC):
    ...
    analyze(). Сканер, журнал, уведомления и Mini App останутся прежними.
    """
